...
Development: https://github.com/geopython/PyWPS

Documentation: https://pywps.org/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5281&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pywps-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pywps` can be installed with `conda`:
...
It is possible to list all of the versions of `pywps` available on your platform with `conda`:
...
```
mamba search pywps --channel conda-forge
```
...
mamba repoquery search pywps --channel conda-forge

# List packages depending on `pywps`:
mamba repoquery whoneeds pywps --channel conda-forge

# List dependencies of `pywps`:
mamba repoquery depends pywps --channel conda-forge
```
